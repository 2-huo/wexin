					...
					<div class="col-md-3 subnav-list">
						<div class="subnav">
							<ol class="clearfix no-padding no-margin">
								...
								<h1 class="pull-left no-margin"><span class="hidden-md hidden-lg"></span>精品案例</h1>
								<small class="text-capitalize pull-left hidden-xs hidden-sm">Product</small>
							</ol>
							<ul class="list-unstyled pcdnav">

								<c:forEach var="category" items="${categoryList}">
									<li><a class="text-center" href="example?categoryId=${category.id}">${category.name}</a></li>
								</c:forEach>
						...
						<div class="row hidden-xs hidden-sm">
							<div class="col-xs-12">
								<div class="title-4 clearfix">
									<h5 class="no-margin pull-left">精品案例</h5>
									<p class="no-margin pull-right"><a href="index" class="tr">首页：</a>精品案例</p>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<div class="pictrue-5 text-center">
									<img src="${example.photo}"  style="padding:1px; border:solid 1px #c6c6c6;">
								</div>
